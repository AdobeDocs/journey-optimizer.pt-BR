...
Este projeto adere à Adobe [código de conduta](code-of-conduct.md). Ao participar, você deve manter esse código. Informe qualquer comportamento inaceitável para
...
Todas as contribuições de terceiros para este projeto devem ser acompanhadas por um contrato de licença do contribuidor assinado. Isso dá à Adobe permissão para redistribuir suas contribuições como parte do projeto. [Assine nosso CLA](http://opensource.adobe.com/cla.html). Você só precisa enviar um CLA da Adobe uma vez, portanto, se já tiver enviado um anteriormente, tudo bem!

## Revisões do código

Todas as propostas devem ser apresentadas sob a forma de pedidos de pull e devem ser revistas pelos autores dos projetos. Ler [Documentação de solicitação de pull do GitHub](https://help.github.com/articles/about-pull-requests/)
