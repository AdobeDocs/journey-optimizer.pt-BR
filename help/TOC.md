...
+ Novidades {#whats-new}
   ...
   + {hide-from-toc}[Notas de versão](using/rn/release-notes-2.md)
   + {hide-from-toc}[Notas de versão](using/rn/release-notes-3.md)
...
+ Desafios de fidelidade {#loyalty-challenges}
   ...
   + {hide-from-toc}[Configurar o programa de fidelidade](using/loyalty-challenges/loyalty-admin.md)
