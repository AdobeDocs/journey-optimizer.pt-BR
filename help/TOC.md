...
+ Jornadas {#orchestrate-journeys}
   ...
   + Criar expressões {#building-advanced-conditions-journeys}
      ...
      + [Gerar expressões com o Assistente de expressão](using/building-journeys/expression/expression-agent.md)
      + Sintaxe {#syntax}
...
+ Campanhas {#campaigns}
   ...
   + Campanhas orquestradas {#orchestrated-campaigns}
      ...
      + Atividades de campanhas orquestradas {#design-campaigns}
         ...
         + {hide-from-toc}[Carregar arquivo](using/orchestrated/activities/load-file.md)
