...
+ Novidades {#whats-new}
  ...
  + {hide-from-toc}[Migrar públicos-alvo em lotes da Qualificação de público-alvo](using/building-journeys/aq-batch-audiences-migration.md)
...
+ Jornadas {#orchestrate-journeys}
  ...
  + Criar expressões {#building-advanced-conditions-journeys}
    ...
    + Sintaxe {#syntax}
      ...
      + {hide-from-toc}[Exemplos](using/building-journeys/expression/advanced-editor-use-cases.md)
  ...
  + Casos de uso {#journey-use-cases}
    ...
    + {hide-from-toc}[Incrementar entregas](using/building-journeys/ramp-up-deliveries-uc.md)
...
+ Desafios de fidelidade {#loyalty-challenges}
  ...
  + Criar e gerenciar desafios {#create-manage-challenges}
    ...
    + [Monitorar o desempenho do desafio de fidelidade](using/loyalty-challenges/loyalty-reporting.md)
  + Configurar e integrar {#configure-integrate-loyalty}
    ...
    + [APIs de desafios de fidelidade](using/loyalty-challenges/loyalty-challenges-api.md)
+ Campanhas {#campaigns}
  ...
  + Campanhas orquestradas {#orchestrated-campaigns}
    ...
    + Atividades de campanhas orquestradas {#design-campaigns}
      ...
      + [Carregar arquivo](using/orchestrated/activities/load-file.md)
...
+ Canais de comunicação {#channels}
  ...
  + Canal de email {#email}
    ...
    + Projetar conteúdo de email {#design-email}
      ...
      + Criar conteúdo {#add-content}
        ...
        + [Usar módulos](using/email/email-modules.md)
        ...
        + [Personalizar URLs](using/email/url-personalization.md)
      ...
      + [Verificação de conteúdo](using/email/content-check.md)
      + [Colaborar em conteúdo de email](using/email/email-collaboration.md)
  ...
  + Canal no aplicativo {#in-app}
    ...
    + Configurar o canal no aplicativo {#configure-inapp}
      + [Configuração do canal no aplicativo e pré-requisitos](using/in-app/inapp-configuration.md)
      + [Configurar mensagens no aplicativo da web no SDK da web](using/in-app/web-in-app-messaging.md)
  + Canal de notificações por push {#push}
  ...
  + Canal da web {#web}
    ...
    + Aplicativos de página única e SDK da web {#web-sdk}
      ...
      + [Journey Optimizer com o SDK da web da Experience Platform](using/web/web-sdk.md)
  ...
  + Caixa de entrada {#inbox}
    ...
    + [Configurar o suporte à caixa de entrada no SDK da web](using/inbox/inbox-configuration-sdk.md)
  ...
  + Atividades ao vivo {#live-activity}
    ...
    + Configurar canal de atividade ao vivo {#configure-live-activity}
  ...
  + Canais personalizados {#custom-channel}
    + [Introdução aos canais personalizados](using/custom-channel/get-started-custom-channel.md)
    + Configurar canais personalizados {#configure-custom-channel}
      + [Defina os canais personalizados](using/custom-channel/configure-custom-channel.md)
    ...
    + Criar experiências de canal personalizado {#create-custom-channel-experiences}
      + [Criar uma experiência de canal personalizado](using/custom-channel/create-custom-experience.md)
      + [Teste a experiência de canal personalizado](using/custom-channel/test-custom-channel.md)
...
+ Gerenciamento de conteúdo {#content-management}
  ...
  + Fragmentos de conteúdo reutilizáveis {#fragments}
    ...
    + [Fragmentos dinâmicos](using/content-management/dynamic-fragments.md)
    + [Gerenciar fragmentos](using/content-management/manage-fragments.md)
    + {hide-from-toc}[Adicionar atributos contextuais aos fragmentos publicados](using/content-management/manage-fragments-contextual-attributes.md)
  ...
  + Casos de uso entre soluções {#combine}
    ...
    + Fragmentos de conteúdo do Experience Manager {#aem}
      ...
      + [Configure o repositório para fragmentos de conteúdo](using/integrations/aem-admin-settings.md)
      + [Trabalhar com fragmentos de conteúdo do Experience Manager](using/integrations/aem-fragments.md)
      + [Gerencie os fragmentos de conteúdo do Adobe Experience Manager](using/integrations/aem-fragments-manage.md)
...
+ Recursos de decisão {#decisioning}
  ...
  + Serviço de decisão {#experience-decisioning}
    ...
    + Coletar dados de eventos {#experience-decisioning-collect-event-data}
      + {hide-from-toc}[Introdução à coleção de dados](using/experience-decisioning/data-collection/data-collection.md)
      + {hide-from-toc}[Criar um conjunto de dados para coletar eventos](using/experience-decisioning/data-collection/create-dataset.md)
...
+ Configuração de canais {#configuration}
  ...
  + {hide-from-toc}[Esquema de exportação de mensagens do AJO](using/configuration/message-export-schema.md)
  ...
  + Delegar subdomínios de email {#delegate-subdomains}
    ...
    + [Migrar de CNAME para delegação personalizada](using/configuration/custom-subdomain-migration.md)
  ...
  + [Suporte para arquivamento de email](using/configuration/archiving-support.md)
