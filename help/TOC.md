...
user-guide-description: Use o Journey Optimizer para criar e entregar experiências conectadas, contextuais e personalizadas para seus clientes
type: Documentation
...
+ Gerenciamento de decisão {#offer-decisioniong}
   ...
   + Referência da API {#api-reference}
      ...
      + Entrega de oferta usando APIs {#offer-delivery}
         + [Sobre APIs do Decisioning e do Edge Decisioning](using/offers/api-reference/offer-delivery-api/decisioning-vs-edge-apis.md)
