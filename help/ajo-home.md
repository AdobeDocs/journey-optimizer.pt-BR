...
<tr>
  <td>
   ...
   <p>
    ...
    <p>
    <div>
      <a href="using/messages/design-emails.md">Criar um conteúdo de email</a>
    </div>
    <p>
    ...
    <div>
    <li>
      <a href="https://www.adobe.com/content/dam/cc/en/security/pdfs/AJO_SecurityOverview.pdf" target="_blank">Visão geral da segurança no Adobe Journey Optimizer</a> (PDF)
    </li>
    </div>
    <div>
    <li>
      <a href="https://experienceleague.adobe.com/docs/journey-optimizer/assets/AJO-FAQ.pdf" target="_blank">Perguntas frequentes sobre o Adobe Journey Optimizer</a> (PDF)
    </li>
    </div>
    <div>
    <li>
   ...
   <div><strong>Links diretos para os principais recursos </strong>
    ...
    <li>
      <a href="using/messages/create-message.md">Mensagens</a>
    </li>
    <p>
    ...
    <li>
      <a href="using/messages/assets-essentials.md">Ativos</a>
    </li>
    <p>
    ...
    <li>
     ...
     <li>
      <a href="using/start/get-started-profiles.md">Perfis</a>
    </li>
    <li>
      <a href="using/start/get-started-identity.md">Identidade</a>
    </li>
    <p>
    <p>ADMINISTRAÇÃO</p>
    <li>
