...
Dê uma olhada nos últimos aprimoramentos do Journey Optimizer! Para obter uma lista abrangente de recursos, melhorias e correções, consulte a seção [Notas de versão](using/rn/release-notes.md).
