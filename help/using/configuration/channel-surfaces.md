...
**Nesta página:** Saiba como criar, monitorar, editar e desativar configurações de canal no Adobe Journey Optimizer para definir os parâmetros técnicos usados para enviar suas mensagens.
...
Para tornar uma configuração de canal **[!UICONTROL Ativa]** indisponível para criar novas mensagens, você pode desativá-la. <!--However, journeys' messages currently using this configuration will not be affected and will continue working.-->
...
Para desativar uma configuração de canal, siga as etapas abaixo.
