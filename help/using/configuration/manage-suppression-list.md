...
Com [!DNL Journey Optimizer], é possível monitorar todos os endereços de email que são excluídos automaticamente de enviarem em uma jornada ou campanha, como:
...
>[!NOTE]
>
>A lista de supressão é operada no nível da sandbox.
...
1. Aguarde até que o arquivo seja gerado.
   ...
   >[!NOTE]
   >
   >O tempo de download depende do tamanho do arquivo, o que significa o número de endereços de email que estão na lista de supressão.
   >
