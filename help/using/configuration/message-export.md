...
>abstract="Selecionar esta opção permite gravar o conteúdo dos emails ou mensagens SMS enviados, utilizando-se esta configuração, em um conjunto de dados [!DNL Experience Platform]. Os registros são retidos por 7 dias a partir da assimilação, durante os quais você pode exportá-los para seu próprio armazenamento."

>[!AVAILABILITY]
>
>No momento, esse recurso está disponível apenas para algumas organizações (disponibilidade limitada). Para obter mais informações, entre em contato com o seu representante da Adobe.
...
Os registros são mantidos no **Conjunto de dados de exportação de mensagens do AJO** por sete dias a partir da assimilação, durante os quais você pode exportá-los para o sistema externo de sua escolha.
<!--
## Terminology
