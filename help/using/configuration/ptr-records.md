...
>abstract="Um registro de ponteiro (PTR) é um tipo de registro DNS que fornece o nome do domínio vinculado a um endereço IP, o que ajuda os servidores de email de recebimento a verificar os endereços IP dos remetentes. Edite um registro PTR somente após devidamente considerar e discutir a questão com seu especialista em capacidade de entrega."

>[!CONTEXTUALHELP]
>id="ajo_admin_ptr_record_header"
>title="Registros PTR de subdomínios"
>abstract="Depois que um subdomínio é delegado ao Adobe no Journey Optimizer, um registro PTR é automaticamente criado e associado a esse subdomínio."
