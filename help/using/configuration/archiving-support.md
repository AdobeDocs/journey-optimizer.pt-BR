...
title: Suporte a arquivamento no Journey Otimizer
...
Regulamentos como o GDPR afirmam que os titulares de dados devem poder modificar o consentimento a qualquer momento. Como os emails CCO que você está enviando com o Journey Otimizer incluem informações de identificação pessoal (PII) seguras, você deve editar a variável **[!UICONTROL CJM Email BCC Feedback Event Schema]** para gerenciar essas PII de acordo com o GDPR e regulamentos semelhantes.
...
>[!NOTE]
>
>Saiba mais sobre como gerenciar a privacidade e os regulamentos aplicáveis na [Documentação da Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/privacy/home.html){target=&quot;_blank&quot;}.

### Dados de relatórios CCO {#bcc-reporting}

Os relatórios como tal no CCO não estão disponíveis nos relatórios de jornada e mensagem. No entanto, as informações são armazenadas em um conjunto de dados do sistema chamado **[!UICONTROL AJO BCC Feedback Event Dataset]**. Você pode executar consultas em relação a esse conjunto de dados para encontrar informações úteis para fins de depuração, por exemplo.
...
Para executar consultas em relação a esse conjunto de dados, você pode usar o Editor de consultas fornecido pelo [Serviço de query da Adobe Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/query/api/getting-started.html){target=&quot;_blank&quot;}. Para acessá-lo, selecione **[!UICONTROL Data management]** > **[!UICONTROL Queries]** e clique em **[!UICONTROL Create query]**. [Saiba mais](../data/get-started-queries.md)
