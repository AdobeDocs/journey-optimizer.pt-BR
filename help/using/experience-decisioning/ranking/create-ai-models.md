...
## Acessar modelos de IA {#access-ai-models}

Para acessar a lista de modelos de IA, acesse **[!UICONTROL Decisão]** > **[!UICONTROL Configuração de estratégia]** e selecione **[!UICONTROL Modelos de IA]**. Todos os modelos de IA criados em sua instância estão listados lá.
...
1. Navegue até o menu **[!UICONTROL Decisão]** > **[!UICONTROL Configuração de estratégia]** e selecione **[!UICONTROL modelos de IA]**.
   ...
   Todos os modelos de IA criados até o momento em sua instância estão listados lá.
...
1. A seção **[!UICONTROL Métrica de otimização]** fornece informações sobre o evento de conversão usado pelo modelo de IA para calcular a classificação das ofertas.
   ...
   * **Eventos de conversão** (ofertas que resultam em cliques por email ou pela Web).
   ...
   Esses eventos são captados automaticamente por meio do SDK da web ou do SDK móvel fornecido. Saiba mais na visão geral do [Adobe Experience Platform Web SDK](https://experienceleague.adobe.com/docs/experience-platform/edge/home.html?lang=pt-BR).
...
1. Salve e ative o modelo de IA. Assim que o modelo estiver online, você poderá [monitorar o status e o desempenho do treinamento](ai-model-observability.md).
