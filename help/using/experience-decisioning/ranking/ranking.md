...
**Nesta página:** crie métodos de classificação, fórmulas ou modelos de IA, e atribua-os a uma estratégia de seleção, para que o mecanismo de decisão saiba quais itens qualificados devem ser apresentados primeiro para cada perfil.
