...
Para criar um item de decisão, navegue até **[!UICONTROL Experience Decisioning]** > **[!UICONTROL Catálogos]**, clique em **[!UICONTROL Criar item]** e siga as etapas detalhadas nas seções abaixo.
