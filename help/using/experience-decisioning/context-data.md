...
**Nesta página:** defina e alimente dados de contexto do Adobe Experience Platform no Decisioning para que você possa usar informações em tempo real enviadas no momento da solicitação de decisão em suas regras de decisão e fórmulas de classificação.
...
* [Sequências de dados](https://experienceleague.adobe.com/pt-br/docs/experience-platform/datastreams/overview){target="_blank"}
