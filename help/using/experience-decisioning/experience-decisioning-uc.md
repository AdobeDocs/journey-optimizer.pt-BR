...
**Nesta página:** siga um caso de uso que cria duas estratégias de seleção e compara métodos de classificação em um experimento de conteúdo de experiência baseado em código, para que você possa determinar qual abordagem de decisão tem melhor desempenho para seu público-alvo.
...
➡️ [Descobrir um caso de uso em vídeo](#video)
...
Após executar o experimento, rastreie o desempenho dos tratamentos da campanha com o [relatório da campanha de experimentação](../reports/campaign-global-report-cja-experimentation.md).<!-- and [report on decisioning](cja-reporting.md).--> Você pode então interpretar os resultados de seu experimento. [Saiba como](../content-management/get-started-experiment.md#interpret-results)
...
Descubra uma apresentação completa mostrando como usar o Decisioning em uma experiência baseada em código.
