---
title: Benefícios da migração para a Decisão
...
# Benefícios da migração para a Decisão {#migrate-to-decisioning}

>[!BEGINSHADEBOX]

**Nesta página:** Entenda os recursos e os benefícios que a Decisão oferece sobre a Gestão de decisões, juntamente com as ferramentas de migração disponíveis, para que você possa decidir se deseja migrar.
