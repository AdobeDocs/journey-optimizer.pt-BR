---
title: Pesquisar uma regra de elegibilidade
...
# Pesquisar uma regra de elegibilidade {#list-eligibility-rule}

Você pode pesquisar uma regra de elegibilidade específica fazendo uma solicitação GET para a API da biblioteca de ofertas que inclui a ID no caminho da solicitação.
...
| `{ID}` | A ID da entidade que você deseja pesquisar. | `rule1234` |
...
Uma resposta bem-sucedida retorna os detalhes da regra de elegibilidade.
