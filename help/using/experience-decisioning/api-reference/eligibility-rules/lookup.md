...
Você pode pesquisar uma regra de elegibilidade específica fazendo uma solicitação GET para a API Biblioteca de ofertas que inclui a ID no caminho da solicitação.
