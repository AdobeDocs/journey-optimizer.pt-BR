...
Você pode pesquisar fórmulas de classificação específicas fazendo uma solicitação GET para a API Biblioteca de ofertas que inclui a ID no caminho da solicitação.
