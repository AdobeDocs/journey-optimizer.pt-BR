...
Você pode pesquisar uma coleção de itens específica fazendo uma solicitação GET para a API Biblioteca de ofertas que inclui a id no caminho da solicitação.
