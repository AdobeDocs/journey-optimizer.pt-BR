...
1. Selecione **[!UICONTROL Inserir política]** (experiência baseada em código) ou **[!UICONTROL Inserir sintaxe]** (email) para adicionar o código correspondente à política de decisão.
