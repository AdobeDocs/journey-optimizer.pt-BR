...
>[!NOTE]
>
>Para migrar da Gestão de decisões para o Decisioning, consulte a [documentação sobre migração](../experience-decisioning/migrate-to-decisioning.md) e o [guia de API de migração](../experience-decisioning/decisioning-migration-api.md).
