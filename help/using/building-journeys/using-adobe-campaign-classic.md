...
Uma integração estará disponível se você tiver o Adobe Campaign v7 ou v8. Ele permitirá enviar emails, notificações por push e SMS usando os recursos de mensagens transacionais do Adobe Campaign.

A conexão entre as instâncias do Journey Otimizer e do Campaign é configurada pela Adobe no momento do provisionamento. Entre em contato com a Adobe.
...
1. Projete sua jornada, começando por um evento. Veja isso [seção](../building-journeys/journey.md).
