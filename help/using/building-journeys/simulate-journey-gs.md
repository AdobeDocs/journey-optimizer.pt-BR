...
| Máximo de usuários simulados por solicitação de geração | 50 | O máximo de usuários simulados que a IA gera em uma solicitação por meio de **[!UICONTROL Simulação rápida]** ou **[!UICONTROL Gerar com a IA]** em **[!UICONTROL Simulação manual]**. Se a jornada tiver mais de **50** caminhos, a IA selecionará aleatoriamente caminhos para produzir esses **50** usuários simulados. |
...
| Retenção de usuário simulada gerada por IA | 10 dias | Os usuários simulados gerados por IA são excluídos automaticamente 10 dias após a criação. |
