...
Para obter mais informações sobre como transformar um perfil existente em um perfil de teste, consulte este [seção](../segment/creating-test-profiles.md#create-test-profiles-csv).
