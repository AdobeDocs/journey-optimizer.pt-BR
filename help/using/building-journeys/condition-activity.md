...
**Nesta página:** saiba como usar a atividade de Condição para rotear perfis para diferentes caminhos de jornada com base em regras, dados e associação de público-alvo.
...
Você também pode basear uma condição em associação de público-alvo. Consulte estas seções:

* [Usar um público em uma condição](#using-a-segment) - Adicionar caminhos com base no fato de os perfis pertencerem a um público.
* [Criar e direcionar públicos-alvo](../audience/about-audiences.md) - Crie e gerencie públicos-alvo no menu Públicos-alvo.
* [Direcionamento de público-alvo no jornada](read-audience.md#audience-targeting-in-journeys) - Após uma atividade Ler público, segmentar, excluir ou mesclar ramificações usando condições.
