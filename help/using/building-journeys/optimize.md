...
Acompanhe o sucesso da sua jornada com o relatório de Experimento de Caminho de Jornada.<!--Reporting page on Journey Path Experimentation to be created - such as what we have for [Experimentation campaign report](../reports/campaign-global-report-cja-experimentation.md)-->
...
➡️ Execute um experimento para verificar se o envio de um email contra três emails durante uma semana resulta em mais compras.
...
Acompanhe o sucesso da sua jornada com o relatório Direcionamento de Caminho de Jornada.<!--Reporting page on Journey Path Targeting to be created - such as what we have for [Experimentation campaign report](../reports/campaign-global-report-cja-experimentation.md)-->
