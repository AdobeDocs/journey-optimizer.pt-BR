...
**Nesta página:** Saiba como usar a atividade Ação para fornecer conteúdo da tela de jornada por meio de uma única atividade unificada que abrange Email, Push, SMS, no aplicativo, Web, experiências baseadas em código e cartões de conteúdo.
...
1. Configure sua atividade de acordo com o canal selecionado. Diretrizes de configuração detalhadas estão disponíveis nos links abaixo.
   ...
   * Saiba mais sobre as etapas detalhadas para criar sua ação de saída da seguinte maneira:
     ...
     <table style="table-layout:fixed">
      ...
      <div>
      <a href="../mobile/create-mobile-message.md"><strong>Criar mensagens móveis (SMS/RCS/MMS)</strong></a>
      </div>
      <p>
      </td>
      </tr>
