...
>[!TIP]
>
>Ao agendar a jornada, você também pode configurar o envio de ondas para entregar ações de jornada em lotes ao longo do tempo. [Saiba como enviar usando ondas no jornada](../delivery/send-using-waves.md)
