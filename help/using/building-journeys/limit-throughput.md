...
Se estiver trabalhando com fontes de dados externas ou ações personalizadas, talvez você queira proteger seus sistemas externos limitando a taxa de transferência do jornada: até 5.000 instâncias/segundo para jornadas unitárias e até 20.000 instâncias/segundo para  acionadas por segmento.
...
Para **jornadas acionadas por segmento**, você pode definir a taxa de limitação da sua atividade Segmento de leitura que afetará a taxa de transferência da jornada.  [Leia mais](../building-journeys/read-segment.md)
...
Vamos ver um exemplo de **jornadas acionadas por segmento** trabalhar com uma população de **10.000 perfis** e enviar dados para um sistema externo que suporte **100 solicitações/segundo**.

1. Você pode definir seu Segmento de leitura para ler perfis com uma taxa de transferência de 500 perfis/segundo, o que significa que levará 20 segundos para ler todos os perfis. No segundo 1, você lerá 500 deles, no segundo mais 2 500, etc.
