...
![Configuração de entrada e saída de público-alvo nas configurações do evento](assets/segment8.png)
...
A velocidade de recepção dessas informações é alta. As medidas mostram uma velocidade de 10.000 eventos recebidos por segundo. Como resultado, certifique-se de entender como os picos de entrada podem acontecer, como evitá-los e como preparar sua jornada para eles. Saiba mais sobre taxas de processamento e limites de taxa de transferência do jornada em [esta seção](entry-management.md#journey-processing-rate).
