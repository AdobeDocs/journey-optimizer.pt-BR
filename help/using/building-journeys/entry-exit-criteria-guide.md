...
[Gerenciamento de entrada de perfil](entry-management.md) | [Propriedades da Jornada e critérios de saída](journey-properties.md) | [Como as jornadas terminam](end-journey.md) | [Identificadores complementares](supplemental-identifier.md) | [Designer de Jornadas](using-the-journey-designer.md)
