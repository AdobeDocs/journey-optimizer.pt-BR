...
1. **Escolha o canal**.
   ...
   >[!NOTE]
   >
   >Para obter mais informações sobre os canais compatíveis, consulte a tabela nesta seção: [canais em jornadas e campanhas](../channels/gs-channels.md#channels). Os canais disponíveis variam com base no modelo de licenciamento e nos complementos.
   >
