...
**Nesta página:** revise a configuração e o conteúdo da campanha de Ação para detectar erros antes de ativá-la, para que você possa enviar a mensagem com confiança imediatamente ou na data agendada.
