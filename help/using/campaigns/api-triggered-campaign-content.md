...
**Nesta página:** Crie e personalize o conteúdo de campanha acionado pela API com dados contextuais transmitidos na carga da API para que cada mensagem seja adaptada em tempo real para cada destinatário.
