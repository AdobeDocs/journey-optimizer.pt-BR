...
>abstract="Para uma mensagem de marketing especificando uma data de envio, a variável **Agendado** tipo é o mais apropriado. No entanto, se você quiser enviar mensagens transacionais como redefinição de senha ou abandono de carrinho, a variável **Acionado pela API** tipo é a melhor escolha."

>[!CONTEXTUALHELP]
>id="ajo_campaigns_campaign_category"
>title="Categoria de campanha"
>abstract="O valor da categoria está diretamente associado ao valor do tipo de campanha. Programar tipo de campanha para o **Marketing** categoria e tipo acionado por API para a categoria **Transacional**"
...
>abstract="Especifique uma data e hora em que a mensagem deve ser enviada."
...
>title="Acionadores de ação de campanha"
