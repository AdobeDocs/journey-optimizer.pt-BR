...
1. Selecionar **[!UICONTROL Email]** em seguida, **[!UICONTROL Preset]** você deseja usar para este delivery. Para obter mais informações, consulte a página Predefinição .
