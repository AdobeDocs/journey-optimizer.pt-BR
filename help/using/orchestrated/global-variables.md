...
title: Definir variáveis globais em campanhas orquestradas
description: Saiba como adicionar e gerenciar variáveis globais em uma campanha orquestrada.
feature: Campaigns
...
1. Clique no ícone **...** ao lado de **[!UICONTROL Salvar]** e selecione **[!UICONTROL Editar variáveis]**.
   ...
   ![Opção Editar variáveis no menu de campanha](assets/variables-list.png){zoomable="yes"}
...
1. Clique em **[!UICONTROL Adicionar variável]** e defina o nome e o valor da variável. Para editar uma variável existente, clique no botão **...** e selecione **[!UICONTROL Editar]**.
   ...
   ![Painel Variáveis para adicionar ou editar variáveis](assets/variables-edit.png){zoomable="yes"}
