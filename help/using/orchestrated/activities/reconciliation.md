...
**Nesta página:** saiba como usar a atividade de direcionamento Reconciliação para corresponder dados externos ou não identificados com registros existentes no banco de dados durante uma campanha Orquestrada.
