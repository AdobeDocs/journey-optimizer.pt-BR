...
**Nesta página:** saiba como usar a atividade Ler público para recuperar um público salvo ou importado existente e reutilizá-lo em uma campanha Orquestrada, enriquecendo-o opcionalmente com atributos de perfil para direcionamento, personalização ou relatórios.
