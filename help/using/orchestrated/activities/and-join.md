...
**Nesta página:** saiba como usar a atividade de controle de fluxo And-join em uma campanha Orquestrada para sincronizar várias ramificações de execução para que a campanha continue somente após a conclusão de todas as atividades anteriores.
