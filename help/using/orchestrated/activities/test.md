...
**Nesta página:** saiba como usar a atividade de controle de fluxo de Teste para ramificar uma campanha Orquestrada ativando transições diferentes com base nas condições definidas.
