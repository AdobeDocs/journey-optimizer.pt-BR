...
**Nesta página:** saiba como usar a atividade de direcionamento de consulta incremental para retornar somente novos registros em cada execução de campanha orquestrada, excluindo perfis já direcionados em execuções anteriores.
