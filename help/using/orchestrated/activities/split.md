...
**Nesta página:** saiba como usar a atividade de direcionamento Split para segmentar a população de entrada de uma campanha Orquestrada em vários subconjuntos com base em regras de filtragem, limites ou tamanho da população.
