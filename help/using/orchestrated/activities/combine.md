...
**Nesta página:** saiba como usar a atividade Combinar direcionamento em uma campanha Orquestrada para segmentar sua população de entrada por meio de operações de união, interseção ou exclusão.
