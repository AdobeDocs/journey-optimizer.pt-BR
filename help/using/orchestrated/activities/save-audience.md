...
**Nesta página:** saiba como usar a atividade de direcionamento Salvar público-alvo para criar ou substituir um público-alvo reutilizável da população criada anteriormente em uma campanha Orquestrada.
