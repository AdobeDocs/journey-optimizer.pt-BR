...
**Nesta página:** saiba como configurar um targeting dimension para campanhas orquestradas, mapeando um esquema relacional para o perfil do cliente para que você possa entregar mensagens no nível da entidade.
...
1. Selecione o **[!UICONTROL Valor de identidade]** que representa a entidade que você deseja direcionar.
   ...
   [Saiba mais na documentação do Adobe Experience Platform](https://experienceleague.adobe.com/pt-br/docs/experience-platform/xdm/schema/composition#identity)
