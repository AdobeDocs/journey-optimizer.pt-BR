...
**Nesta página:** saiba mais sobre as funções de fidelidade padrão, as permissões disponíveis, os recursos de função, o escopo da sandbox e como atribuir funções aos usuários.
