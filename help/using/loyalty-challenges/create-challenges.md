...
**Nesta página:** Saiba como criar, configurar, publicar e iniciar desafios de fidelidade, incluindo suas configurações, estrutura, conteúdo, mensagens, tarefas e recompensas.

>[!ENDSHADEBOX]

Esta página aborda o processo completo de criação e publicação de um desafio de fidelidade no Adobe Journey Optimizer.
...
1. Navegue até **[!UICONTROL Desafios de fidelidade]** na Journey Optimizer.
...
1. Selecione seu provedor de premiação. Esta é a sua solução de fidelidade que gerencia pontos e recompensas do cliente. Os provedores de recompensa são criados no menu **[!UICONTROL Configurações de fidelidade]** antes de você criar desafios. [Saiba como configurar provedores de premiação](loyalty-admin.md#reward-providers)
