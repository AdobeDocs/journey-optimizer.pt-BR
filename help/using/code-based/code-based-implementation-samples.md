...
➡️ Saiba mais sobre como configurar o Web SDK para decisões e experiências baseadas em código em [estes tutoriais](code-based-decisioning-implementations.md#tutorials)
