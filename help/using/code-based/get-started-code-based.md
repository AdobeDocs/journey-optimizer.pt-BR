...
1. Componha uma experiência especificando o conteúdo da superfície selecionada usando o editor de personalização do [!DNL Journey Optimizer]. [Saiba como](create-code-based.md#edit-code)
