...
**Nesta página:** as políticas de aprovação determinam quais jornadas e campanhas exigem aprovação antes de serem publicadas, permitindo que os administradores definam as condições, os critérios de direcionamento e os revisores que controlam cada solicitação.
...
>abstract="Habilite essa opção para impedir que os usuários aprovem as próprias solicitações de aprovação, mesmo quando pertencerem a um grupo de usuários ou função designada como revisor."
...
1. Habilite o **[!UICONTROL Bloquear autoaprovação]** para impedir que os criadores de Jornadas/Campanhas aprovem seus próprios objetos.
   ...
   ![Formulário de detalhes da política de aprovação](assets/policy_create_2.png)
