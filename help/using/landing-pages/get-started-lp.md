...
1. [**Testar**](create-lp.md#test-landing-page) e [**publicar**](create-lp.md#publish-landing-page) sua página de aterrissagem — visualize a página, teste o comportamento do formulário e publique para ativá-la.
