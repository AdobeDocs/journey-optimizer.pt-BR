...
description: Saiba como criar conteúdo específico de página de aterrissagem no Journey Otimizer
...
Para definir um conteúdo específico que permitirá que os usuários selecionem e enviem suas opções a partir da página de aterrissagem, use o **[!UICONTROL Form]** componente. Para fazer isso, siga as etapas abaixo.
...
Por exemplo, se você vincular uma caixa de seleção<!-- or the submission of the page--> para [lista de assinaturas](subscription-list.md) na página de aterrissagem principal, você pode usar essa lista de subscrição na subpágina &quot;thank you&quot;.
...
1. Na subpágina, coloque o ponteiro do mouse onde deseja inserir o texto e selecione **[!UICONTROL Add personalization]** na barra de ferramentas contextual.

   ![](assets/lp_designer-form-subpage-perso.png)

1. No **[!UICONTROL Edit personalization]** janela , selecione **[!UICONTROL Contextual attributes]** > **[!UICONTROL Landing Pages]** > **[!UICONTROL Primary Page Context]** > **[!UICONTROL Subscription]**.
