...
>abstract="Seu subdomínio será configurado para uso como página de aterrissagem. Você pode usar um subdomínio que já está delegado ao Adobe ou configurar outro subdomínio."

>[!CONTEXTUALHELP]
>id="ajo_admin_subdomain_lp"
>title="Delegar um subdomínio de página de destino"
>abstract="Você deve configurar um subdomínio para usar nas páginas de aterrissagem, pois ele será necessário para criar uma predefinição de página de aterrissagem. Você pode usar um subdomínio já delegado ao Adobe ou configurar um novo subdomínio."
...
>abstract="Para criar uma predefinição de página de aterrissagem, verifique se você configurou anteriormente pelo menos um subdomínio de página de aterrissagem para escolher na lista de nomes de subdomínio."
>additional-url="https://experienceleague.adobe.com/docs/journey-optimizer/using/landing-pages/lp-configuration/lp-presets.html#lp-create-preset" text="Criar predefinições de página de destino"
