...
Para configurar uma página de aterrissagem para o registro de eventos, crie uma lista de assinaturas, crie a página de aterrissagem com um formulário de registro e defina as páginas e as configurações necessárias. Siga estas etapas:
