...
description: Saiba como configurar e publicar uma landing page no Journey Otimizer
...
1. Para atribuir rótulos de uso de dados personalizados ou principais à página inicial, selecione **[!UICONTROL Manage access]**. [Saiba mais sobre o Controle de Acesso no Nível do Objeto (OLAC)](../administration/object-based-access.md)
...
1. No **[!UICONTROL Additional data]** , defina uma ou mais chaves e seus valores de parâmetro correspondentes. Você poderá aproveitar essas chaves no conteúdo da página primária e das subpáginas usando o [Editor de expressão](../personalization/personalization-build-expressions.md). Saiba mais em [esta seção](lp-content.md#use-form-component#use-additional-data).
...
1. Na página de aterrissagem, é possível diretamente [criar uma jornada](../building-journeys/journey-gs.md#jo-build) que enviará uma mensagem de confirmação para os usuários quando enviarem o formulário. Aprenda a criar tal jornada no final [caso de uso](lp-use-cases.md#subscription-to-a-service).
...
1. No **[!UICONTROL Preview & test]** selecione um ou mais perfis de teste.
   ...
   As etapas para selecionar perfis de teste são as mesmas que ao testar uma mensagem. Eles são detalhados em [esta seção](../email/preview.md#select-test-profiles).
