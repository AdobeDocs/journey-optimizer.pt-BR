...
Você pode encontrar o controle do alternador de sandbox na parte superior direita da tela ao lado do nome da sua organização. Para alternar de uma sandbox para outra, clique na sandbox ativa no momento no alternador e selecione outra sandbox na lista suspensa.
