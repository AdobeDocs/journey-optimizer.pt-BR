...
➡️ [Saiba mais sobre o controle de acesso no Adobe Journey Otimizer neste vídeo](#video)
...
Cada conceito pode ser gerenciado por **[!UICONTROL Product administrators]** que têm acesso ao Admin Console. [Saiba mais sobre o Adobe Admin Console](https://helpx.adobe.com/enterprise/managing/user-guide.html).

![](assets/do-not-localize/permissions_2.png)

## Vídeo tutorial{#video}

Saiba mais sobre o sistema de controle de acesso e perfis de produto personalizados no Adobe Journey Otimizer. Saiba como gerenciar perfis e permissões de produtos e como adicionar e gerenciar usuários.
