...
**Nesta página:** Entenda como as permissões de alto nível agrupam as permissões de baixo nível subjacentes para cada recurso, para que você possa conceder às funções exatamente o acesso ao recurso de que os usuários precisam.
