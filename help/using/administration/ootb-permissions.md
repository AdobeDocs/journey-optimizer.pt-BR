...
| Biblioteca da Journey Optimizer | **[!DNL Manage Library Items]**: adicione e exclua expressões salvas na [!DNL Journey Optimizer] Biblioteca.</br>**[!DNL Simulate content]**: acesso à opção Simular conteúdo para pré-visualização e prova. |
