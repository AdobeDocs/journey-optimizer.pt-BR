...
**Nesta página:** habilite conjuntos de dados do Adobe Experience Platform baseados em registros para pesquisa, de modo que você possa enriquecer a personalização, a Decisão e a orquestração de jornadas com dados de referência e transacionais recuperados em tempo de execução no Journey Optimizer.
...
>[!NOTE]
>
>O recurso de pesquisa de dados está com Disponibilidade limitada e está disponível para todos os clientes da Journey Optimizer.
