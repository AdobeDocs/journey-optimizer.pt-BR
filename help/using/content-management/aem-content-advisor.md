...
1. No Editor do Personalization, escolha o ponto de entrada de conteúdo:
   ...
   * Para adicionar um ativo, clique em **[!UICONTROL Assets]** e em **[!UICONTROL Abrir o AEM Content Advisor]**.

     ![](assets/content-advisor-11.png){zoomable="yes"}

   * Para adicionar um fragmento de conteúdo do Adobe Experience Manager, clique em **[!UICONTROL Fragmento de conteúdo do AEM]** e em **[!UICONTROL Abrir o Supervisor de Conteúdo do AEM]**.
