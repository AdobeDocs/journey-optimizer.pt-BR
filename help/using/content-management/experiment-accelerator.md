...
>[!AVAILABILITY]
>
>O **Experimentation Accelerator** exige que os clientes tenham uma licença do Adobe Target ou do Adobe Journey Optimizer.
...
## Acelerador de experimentação de acesso
...
Você pode acessar o **[!UICONTROL Experimentation Accelerator]** no menu suspenso [!UICONTROL Experimentação] ou pelo alternador Aplicativos. Observe que os usuários somente com uma licença do Target podem acessá-la somente por meio do alternador de Aplicativos.
...
* **Para usuários do Adobe Target com Journey Optimizer**: qualquer atividade A/B no Target aparece em **[!UICONTROL Experimentation Accelerator]** na sandbox de produção do Journey Optimizer.
...
Para usar o **[!UICONTROL Experimentation Accelerator]**, você precisa acessar a sandbox e a seguinte permissão relacionada.
