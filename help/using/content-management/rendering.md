...
**Nesta página:** saiba como conectar sua conta Litmus ao Adobe Journey Optimizer para testar a renderização de email em clientes populares de desktop, dispositivos móveis e baseados na Web.
