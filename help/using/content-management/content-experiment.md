...
**Nesta página:** saiba como criar um experimento de conteúdo para definir e comparar vários tratamentos, escolher um tipo de experimento e dimensionar a variação vencedora entre suas campanhas e jornadas no Adobe Journey Optimizer.
