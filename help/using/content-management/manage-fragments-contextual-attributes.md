...
**Nesta página:** saiba como clientes selecionados podem adicionar atributos contextuais a fragmentos já publicados usando o editor de códigos, além das medidas de proteção e limitações que devem ser consideradas.
