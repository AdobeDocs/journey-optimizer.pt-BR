...
**Nesta página:** Saiba como usar o Assistente de IA no Adobe Journey Optimizer para gerar, refinar e selecionar imagens da marca para seu conteúdo de email, Web, página de aterrissagem e notificação por push.
