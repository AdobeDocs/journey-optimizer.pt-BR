...
Uma vez [perfis de teste](test-profiles.md) forem selecionadas, você poderá enviar provas.
...
1. Selecione o **Perfis de teste** para usar a para personalizar o conteúdo da mensagem.
