...
**Nesta página:** conheça casos de uso práticos do Assistente de IA no Adobe Journey Optimizer, desde a reutilização de conteúdo existente e o refinamento de variações de texto até a geração de imagens, a aplicação de referências de estilo e o trabalho em idiomas compatíveis.
