...
description: Saiba mais sobre como usar a opção Gerar conteúdo por meio de casos de uso
...
![Demonstração animada mostrando a opção Gerar conteúdo reutilizando o conteúdo de campanha existente para gerar novas variações](assets/do-not-localize/gen-ai-reuse-text.gif)
...
![Demonstração animada do carregamento de uma imagem de referência para guiar o estilo de geração de imagem Generate Content](assets/do-not-localize/uc-image-reference.gif)
...
![Demonstração animada do conteúdo gerado em vários idiomas, incluindo francês, espanhol e alemão](assets/do-not-localize/gen-ai-language.gif)
...
1. Escolha o **[!UICONTROL Modo]** no menu **[!UICONTROL Configurações de imagem]**:
   ...
   * **[!UICONTROL Equilibrado]**: primeiro, a IA usa a imagem correspondente da sua biblioteca de Gerenciamento de ativos digitais. Quando isso não é suficiente para cobrir os visuais que você precisa, ele gera imagens com IA.
   ...
   * **[!UICONTROL Creative]** (padrão): a IA cria imagens com IA gerativa e não extrai imagens diretamente da sua biblioteca de Gerenciamento de ativos digitais.
