...
title: Introdução ao recurso Gerar conteúdo no Journey Optimizer
description: Saiba como acessar e trabalhar com o recurso Gerar conteúdo no Journey Optimizer
...
# Introdução ao recurso Gerar conteúdo {#gs-content-assistant}

>[!BEGINSHADEBOX]

**Nesta página:** saiba como acessar o recurso Gerar conteúdo no Adobe Journey Optimizer, definir as permissões necessárias e entender as diretrizes e limites para a geração de conteúdo de texto e imagem.
...
>abstract="Após elaborar e personalizar a entrega, é possível usar IA para editar e aprimorar o conteúdo. Esse recurso simplifica o processo de personalização e melhoria de conteúdo, permitindo ajustar o conteúdo com uma descrição do que deseja gerar."

>[!CONTEXTUALHELP]
>id="ajo_ai_generation_context"
>title="Fazer upload do ativo da marca"
>abstract="O menu Fazer upload do ativo da marca habilita a adição de qualquer ativo da marca com conteúdo que possa fornecer contexto adicional para o recurso Gerar conteúdo no Journey Optimizer ou a seleção de um ativo enviado anteriormente. Essa opção garante que o recurso Gerar conteúdo tenha acesso a todos os materiais necessários para aprimorar sua funcionalidade e relevância."
...
O recurso Gerar conteúdo no Adobe Journey Optimizer, com tecnologia Microsoft Azure OpenAI e Adobe Firefly, traz sugestões proativas de variação de conteúdo para texto e as imagens. Esse novo recurso fornece **geração de texto e imagens baseada em prompts**. A geração de imagens é gerenciada pelo Adobe Firefly.

O recurso Gerar conteúdo oferece suporte à geração de conteúdo **em vários idiomas**, permitindo alcançar e engajar diversos públicos-alvo globais. O recurso Gerar conteúdo está disponível nos seguintes idiomas:
...
>
>
>* Você deve aceitar um [contrato de usuário](https://www.adobe.com/legal/licenses-terms/adobe-dx-gen-ai-user-guidelines.html?lang=pt-BR){target="_blank"} antes de poder usar o recurso Gerar conteúdo no Adobe Journey Optimizer. Para obter mais informações, entre em contato com o(a) representante da Adobe.

## Acessar o recurso Gerar conteúdo {#generative-access}

Para acessar o recurso Gerar conteúdo no Adobe Journey Optimizer, os usuários precisam receber a permissão para usar o recurso **Gerar conteúdo**. [Saiba mais](../administration/permissions.md)
...
As diretrizes gerais para usar o recurso Gerar conteúdo no Adobe Journey Optimizer na geração de emails estão listadas abaixo:
...
* Use um modelo personalizado ou específico da marca para criar seu conteúdo de email usando o recurso Gerar conteúdo no Adobe Journey Optimizer. Recomenda-se um modelo de email com 8-10 imagens, no máximo.

### Uso legal e transparência

* O uso do recurso Gerar conteúdo está sujeito às diretrizes do usuário para IA generativa da Adobe Experience Cloud. [Saiba mais](https://www.adobe.com/legal/licenses-terms/adobe-dx-gen-ai-user-guidelines.html?lang=pt-BR)
...
As seguintes medidas de proteção aplicam-se ao recurso [Gerar conteúdo para expressões de personalização](generative-personalization-expressions.md) no [!UICONTROL Editor de personalização] e no Designer de email.
...
## Recursos Gerar conteúdo {#generative-features}
...
* **[Casos de uso do recurso Gerar conteúdo](generative-uc.md)**: aprenda a usar o recurso Gerar conteúdo por meio de casos de uso
* **[Tutoriais do recurso Gerar conteúdo](https://experienceleague.adobe.com/pt-br/docs/journey-optimizer-learn/tutorials/introduction-to-journey-optimizer/ai-assistant){target="_blank"}**: explore tutoriais em vídeo passo a passo sobre as funcionalidades e as práticas recomendadas do recurso Gerar conteúdo.
