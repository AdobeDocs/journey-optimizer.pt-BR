...
* Saiba mais sobre os pré-requisitos do experimento de conteúdo para o canal Web em [esta seção](../web/web-prerequisites.md#experiment-prerequisites).

* Saiba mais sobre a configuração do canal no aplicativo [nesta seção](../in-app/inapp-configuration.md).
