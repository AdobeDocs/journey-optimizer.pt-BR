...
1. Adicione o token de nome:
   ...
   1. Adicione o token **[!UICONTROL Nome]** à expressão.
      ...
      Saiba mais sobre o tipo de dados de nome de pessoa na [documentação da Adobe Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/xdm/data-types/person-name.html?lang=pt-BR){target="_blank"}.
