...
* Geral: `let`, `export`, `to`, `as`, `this`, `last`, `next`, `now`, `NOW`, `today`, `yesterday`, `tomorrow`, `from`, `FROM`, `From`, `before`, `BEFORE`, `Before`, `after`, `AFTER`, `After`
* Unidades de tempo: `millisecond`, `milliseconds`, `second`, `seconds`, `minute`, `minutes`, `hour`, `hours`, `day`, `days`, `week`, `weeks`, `month`, `months`, `year`, `years`, `decade`, `decades`, `century`, `centuries`, `millennium`, `millennia`
* Operadores booleanos e lógicos: `true`, `TRUE`, `True`, `false`, `FALSE`, `False`, `not`, `NOT`, `Not`, `and`, `AND`, `And`, `or`, `OR`, `Or`, `null`, `NULL`, `Null`
