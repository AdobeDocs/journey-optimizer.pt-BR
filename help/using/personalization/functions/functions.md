...
<table>
    ...
    <tr>
        <td><a href="dates.md#format-date-locale">Formatar data com suporte para localidade</a></td><td>Essa função formata um valor de hora de data em sua representação correspondente sensível ao idioma, ou seja, em um local desejado.</td>
    </tr>
    <tr>
