...
* Adição de um vídeo sobre o playground do editor de personalização para ajudá-lo a aprender a escrever e testar o código de personalização usando dados de amostra. [Leia mais](../personalization/personalize.md#how-to-videosvideo-perso)
