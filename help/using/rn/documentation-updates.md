...
* Uma observação foi adicionada às páginas Introdução a perfis e Medidas de proteção para especificar que, ao assimilar dados, os emails fazem distinção entre maiúsculas e minúsculas, o que significa que perfis duplicados podem ser criados e usados ao direcionar esses perfis. [Leia mais](../audience/get-started-profiles.md)
