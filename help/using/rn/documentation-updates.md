...
* Uma nova página está disponível para detalhar as jornadas da interface do usuário de gerenciamento de jornadas. [Leia mais](../building-journeys/journey-ui.md)
...
* Todos os novos recursos e melhorias presentes no lançamento de agosto de 2024 do [!DNL Journey Optimizer] foram detalhados na documentação. [Leia mais](release-notes.md)
...
* Todos os novos recursos e aprimoramentos da versão de 24 de julho do [!DNL Journey Optimizer] estão detalhados na documentação. [Leia mais](release-notes.md)
...
* Todos os novos recursos e aprimoramentos da versão de maio de 2024 do [!DNL Journey Optimizer] foram detalhados na documentação. [Leia mais](release-notes.md)
...
* O editor de expressão usado para personalizar o conteúdo foi renomeado na documentação como “editor de personalização”. Isso foi feito para diferenciá-lo claramente do [Editor de expressão de jornada](../building-journeys/expression/expressionadvanced.md). [Leia mais](../personalization/personalization-build-expressions.md)
...
* As capturas de tela foram atualizadas para refletir a tela de jornada aprimorada.
* As restrições de nomenclatura foram atualizadas nas seguintes páginas: [Configurar um evento unitário](../event/about-creating.md), [Configurar um evento comercial](../event/about-creating-business.md#gs-business-events), [Configurar uma ação personalizada](../action/about-custom-action-configuration.md#configuration-steps), [Fontes de dados externas](../datasource/external-data-sources.md)
* Adição de uma observação sobre a disponibilidade da Otimização de tempo de envio. [Leia mais](../building-journeys/send-time-optimization.md)
* Adição de um novo caso de uso técnico sobre como criar uma ação personalizada para enviar dados para a Experience Platform. [Leia mais](../building-journeys/custom-action-aep.md)
...
* Para jornadas no modo de teste, os seguintes atalhos foram desabilitados:
   * T: atalho para ativar ou desativar o modo de teste.
...
* Um novo status para campanhas por email foi adicionado aos status da lista de campanhas. [Leia mais](../campaigns/modify-stop-campaign.md#campaign-statuses-and-alerts-statuses)
* A seção Introdução aos públicos-alvo da Adobe Experience Platform foi atualizada para refletir os métodos de avaliação de público-alvo disponíveis e como selecioná-los. [Leia mais](../audience/about-audiences.md#evaluation-method-in-journey-optimizer)
...
* Adição de GIFs para ilustrar alguns dos principais recursos, como: [modelos de conteúdo](../content-management/content-templates.md), [fragmentos](../content-management/fragments.md), [atributos computados](../audience/computed-attributes.md), [correspondência direta](../direct-mail/get-started-direct-mail.md), [tags](../start/search-filter-categorize.md#tags), [modelos de otimização da gestão de decisões](../offers/ranking/personalized-optimization-model.md), [campanhas acionadas por API](../campaigns/api-triggered-campaigns.md) e [experimento de conteúdo](../content-management/content-experiment.md).
...
* Várias **métricas de relatórios de campanha**, nos relatórios dinâmicos e globais, foram renomeadas. [Leia mais](../reports/campaign-live-report.md)
...
* Atualização da página de documentação da atividade de espera com informações adicionais e práticas recomendadas relacionadas ao tempo-limite global e ao uso de reentrada. [Leia mais](../building-journeys/wait-activity.md)
...
* A seção **Definir configurações de canal** foi esclarecida e atualizada com links para a página que descreve como configurar o canal de SMS. [Leia mais](../configuration/channel-surfaces.md#create-channel-surface)
...
* A Otimização de tempo de envio agora está disponível para todos os clientes. A menção ao beta foi removida. [Leia mais](../building-journeys/send-time-optimization.md)
...
* Agora, todos os recursos da Gestão de decisões descritos na seção dedicada também se aplicam a usuários da Adobe Experience Platform que utilizam o aplicativo do Offer Decisioning. [Leia mais](../offers/get-started/starting-offer-decisioning.md)
...
* Observações adicionadas às seções Lista de supressão, Lista de permissões e Relatório de email global/em tempo real para especificar que os perfis com status Suprimido e Não permitido estão excluídos das métricas do relatório de emails enviados. [Leia mais](../reports/report-gs-cja.md)
