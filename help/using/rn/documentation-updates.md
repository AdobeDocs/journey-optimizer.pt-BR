...
* Uma observação foi adicionada às páginas Introdução a perfis e Medidas de proteção para especificar que, ao assimilar dados, os emails fazem distinção entre maiúsculas e minúsculas, o que significa que perfis duplicados podem ser criados e usados ao direcionar o recipient correspondente. [Leia mais](../audience/get-started-profiles.md)
...
* A documentação do Experimentation Accelerator foi transferida para uma coleção separada. [Leia mais](https://experienceleague.adobe.com/en/docs/experimentation-accelerator/using/overview)
