...
* Uma proteção sobre o direcionamento de perfis pseudônimos com canais de entrada foi adicionada à página [Medidas de proteção e limitações](../start/guardrails.md#profile-management-inbound). Essa garantia especifica que o direcionamento de perfis que não são autenticados ou conhecidos ainda aumenta sua contagem total de perfis ativáveis e pode afetar seu faturamento. É por isso que a Adobe recomenda configurar um TTL (Time-To-Live) para a exclusão automática de perfis, a fim de gerenciar a contagem de perfis ativáveis e os custos associados.
