...
* Uma observação foi adicionada à seção Fragmentos, especificando que, quando o rastreamento é ativado em uma jornada ou campanha, se os links estiverem presentes em um fragmento e se esse fragmento for usado em um email, esses links serão rastreados como todos os outros links incluídos na mensagem. [Saiba mais](../content-management/create-fragments.md#content)
