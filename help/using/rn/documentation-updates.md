...
* A página Otimização em campanhas foi atualizada para refletir o fato de que a otimização agora também está disponível nas jornadas. [Leia mais](../campaigns/gs-message-optimization.md)

* Um link para o tutorial em vídeo que descreve como aproveitar a otimização de mensagens em uma campanha foi adicionado. [Leia mais](../campaigns/gs-message-optimization.md)
