...
* Adição de práticas recomendadas para pesquisas de conjunto de dados: mantenha os botões ativados para evitar problemas de indexação e entender como as exclusões em lote afetam os dados de pesquisa. [Leia mais](../data/lookup-aep-data.md#guardrails--guidelines-guidelines)

* Adição de uma limitação observando que somente os públicos-alvo do Serviço de perfil unificado são compatíveis ao usar as jornadas Ler público-alvo com identificadores complementares. [Leia mais](../building-journeys/supplemental-identifier.md#guardrails--limitations-guardrails)

## Setembro de 2025 {#september-2025}

* Uma nova seção Canal de entrada foi adicionada à página Medidas de proteção e limitações para coletar todas as limitações aplicáveis aos canais da Web, no aplicativo, de experiências baseadas em código e de cartões de conteúdo. Inclui o limite de volume de pico de 5.000 solicitações de entrada por segundo para todas as solicitações de entrada e o máximo de 500 ações de entrada ativas. [Leia mais](../start/guardrails.md#inbound-guardrails)
