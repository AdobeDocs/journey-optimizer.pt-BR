...
* A documentação de amostras de implementação baseada em código foi atualizada para incluir o campo de tokens na propositionAction para rastreamento e atribuição precisos na Decisão. [Leia mais](../code-based/code-based-implementation-samples.md)
