...
## 2025 de setembro {#september-2025}

* A documentação sobre como usar identificadores complementares no jornada agora inclui uma tabela que detalha como os perfis se comportam quando os critérios de saída são aplicados em jornadas que usam IDs complementares. [Leia mais](../building-journeys/supplemental-identifier.md#exit-criteria)

* Foram adicionadas informações na documentação de visão geral de schemas para diferenciar esquemas padrão e relacionais usados para campanhas orquestradas. [Leia mais](../data/gs-data.md)
...
* Esclarecimento de que as chamadas da API REST de execução de mensagem interativa têm um tempo limite de 60 segundos, com tentativas internas para garantir a entrega. [Leia mais](../campaigns/trigger-campaigns.md)

* A página de coleções de itens da Decisão foi atualizada para esclarecer o comportamento do operador **CONTAINS** ao definir regras. [Leia mais](../experience-decisioning/collections.md)
...
* Uma nova página que lista as práticas recomendadas para criação de email acessível e conteúdo de página de aterrissagem com [!DNL Journey Optimizer] foi adicionada. [Leia mais](../email/accessible-content.md)
