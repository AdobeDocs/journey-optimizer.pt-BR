...
* Uma nova página agora está disponível explicando o que é uma superfície de experiência baseada em código, incluindo URIs de superfície, como as superfícies funcionam como contêineres em qualquer nível de hierarquia (páginas da Web, aplicativos móveis, locais de conteúdo) e como elas conectam a implementação do aplicativo à configuração de canal. [Leia mais](../code-based/code-based-surface.md)

* Uma nova página está disponível sobre como publicar e gerenciar experiências baseadas em código, incluindo a ativação de campanhas, o monitoramento do delivery, a realização de modificações e a interrupção de campanhas. [Leia mais](../code-based/publish-code-based.md)

* Uma nova página agora está disponível sobre o teste de experiências baseadas em código, que aborda como visualizar o conteúdo com perfis de teste, validar a implementação usando ferramentas de desenvolvedor do navegador ou ferramentas de depuração móvel e verificar se o conteúdo é exibido corretamente antes da publicação. [Leia mais](../code-based/test-code-based.md)
...
* Uma nova página agora está disponível na seção Experience Decisioning sobre como configurar a coleta de dados para rastrear impressões, cliques e eventos personalizados. [Leia mais](../experience-decisioning/data-collection/schema-requirement.md)
...
* Uma nova página foi adicionada para descrever como é possível usar as políticas de consentimento para honrar as preferências dos clientes com base em suas escolhas, respeitando o consentimento deles. [Leia mais](../action/preference-center.md)
