...
<p>Saiba mais sobre a delegação de subdomínios CNAME na <a href="../configuration/delegate-subdomain.md#cname-subdomain-setup">documentação detalhada</a>.</p>
</td>
</tr>
</tbody>
</table>
...
* **Pesquisa**: em todas as páginas, agora você pode pesquisar objetos de negócios e artigos de ajuda diretamente no campo de pesquisa unificada do [!DNL CX Enterprise]. [Saiba mais](../start/user-interface.md#unified-search)
