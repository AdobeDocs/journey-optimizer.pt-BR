...
* Ao criar suas jornadas, os alertas agora são exibidos em uma lista suspensa, para que se alinhem aos alertas de campanha e proporcionem uma experiência de usuário consistente. [Leia mais](../building-journeys/troubleshooting.md#checking-for-errors-before-testing)
* As opções de zoom na barra de ferramentas da jornada foram aprimoradas: a porcentagem de zoom agora está visível e é possível redefinir facilmente o valor do zoom para 100%.
