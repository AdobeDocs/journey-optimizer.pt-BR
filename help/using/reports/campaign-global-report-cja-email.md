...
## Funnel de clique único

![](assets/cja-email-click-funnel.png)

O gráfico **[!UICONTROL Click funnel]** apresenta uma análise detalhada de como os perfis se envolveram com seu conteúdo de email, oferecendo insights valiosos em cada estágio da interação, desde a entrega até os cliques, ajudando você a entender com que eficiência suas mensagens impulsionam o engajamento do usuário.
...
* **[!UICONTROL CTR estimado]** (taxa de click-through): calculado como cliques estimados em relação ao número total de mensagens entregues.
