...
**Nesta página:** Saiba como ler as métricas de experiência baseadas em código no relatório de jornada, incluindo dados de exibição e clique, dados de rastreamento e rótulos de links rastreados para suas experiências baseadas em código.
