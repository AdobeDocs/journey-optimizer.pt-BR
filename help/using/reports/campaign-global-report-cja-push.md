...
**Nesta página:** saiba como ler o relatório Campanha de notificação por push no Adobe Journey Optimizer para revisar as estatísticas de envio e rastreamento, links rastreados e os motivos de rejeição, erro e exclusão das suas notificações por push.

>[!ENDSHADEBOX]

>[!BEGINSHADEBOX]

Você pode acessar o relatório de campanha de notificação por push clicando no botão **[!UICONTROL Relatórios]** da campanha e selecionando **[!UICONTROL Exibir relatório de todos os tempos]**. [Saiba mais](report-gs-cja.md)
