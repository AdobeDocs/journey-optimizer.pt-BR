...
**Nesta página:** saiba como configurar uma fonte de dados de relatórios adicionando conjuntos de dados para que o Journey Optimizer possa recuperar as métricas adicionais usadas em seus relatórios de experimentação e campanha.
