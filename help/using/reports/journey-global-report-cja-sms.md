...
description: Saiba como usar dados de SMS no relatório de jornada
...
**Nesta página:** Entenda as métricas de SMS no relatório de jornada do Adobe Journey Optimizer, incluindo as tendências de entrega e cliques, links rastreados, mensagens de entrada, provedores, e os motivos de rejeição, erro e exclusão.
...
A tabela **[!UICONTROL Visão geral da campanha]** serve como um painel para o desempenho do SMS para cada ação de campanha no jornada. Ele resume perfis direcionados, métricas de cliques e click-throughs (incluindo cliques estimados que excluem tráfego de interação de bot e não humano) e resultados do delivery, como rejeições, erros de envio e exclusões.
