...
Para acessar os relatórios, selecione **[!UICONTROL Report]** no menu avançado da landing page selecionada.
...
* **[!UICONTROL Total visits]**: Número total de visitas à sua página de aterrissagem de uma jornada ou outras fontes, incluindo várias visitas de um recipient.
...
* **[!UICONTROL Other sources]**: Número de visitas à sua página de aterrissagem provenientes de uma fonte externa em vez de uma jornada.
