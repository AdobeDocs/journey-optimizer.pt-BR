...
O relatório Campaign Global pode ser acessado diretamente de sua Campanha com a **[!UICONTROL All time]** botão.

![](assets/campaign_report_global_5.png)

A campanha **[!UICONTROL Global report]** será exibida com as seguintes guias:

* [Campanha](#campaign-global)
* [Email](#email-global)
...
Para obter uma lista detalhada de cada métrica disponível no Adobe Journey Otimizer, consulte [esta página](global-report.md#list-of-components-global.md)
...
* **[!UICONTROL Excluded]**: Número de perfis que foram excluídos pelo Adobe Journey Otimizer.
...
Da sua campanha **[!UICONTROL Global report]**, o **[!UICONTROL Push notification]** detalha as informações principais relativas aos deliveries por push enviados na campanha.
...
Da sua campanha **[!UICONTROL Global report]**, o **[!UICONTROL SMS]** detalha as informações principais relativas aos deliveries de SMS enviados na campanha.
