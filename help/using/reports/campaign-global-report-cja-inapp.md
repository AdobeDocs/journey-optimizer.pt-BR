...
**Nesta página:** saiba como ler o relatório de campanha no aplicativo no Adobe Journey Optimizer para analisar tendências de exibição e cliques, dados de rastreamento e links rastreados para suas mensagens no aplicativo.
