...
**Nesta página:** faça referência aos campos de evento da etapa de jornada organizados por categoria, incluindo os campos de evento de depuração, jornada, perfil e serviço, e solucione problemas de tipos de evento descartados.
