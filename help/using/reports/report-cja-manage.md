...
1. Selecione o menu do construtor de Insight no menu do painel esquerdo.
...
Agora há a opção de aprimorar os relatórios do Journey Optimizer aproveitando os modelos do Customer Journey Analytics. [Saiba mais sobre o modelo do Customer Journey Analytics](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/templates/use-templates#use-reports)
