...
**Nesta página:** gerencie seus relatórios do Adobe Journey Optimizer analisando dados no Customer Journey Analytics, definindo períodos de relatório, exportando e agendando relatórios, criando métricas personalizadas e criando públicos.
