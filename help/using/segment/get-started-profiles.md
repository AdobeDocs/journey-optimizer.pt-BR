...
title: Introdução a perfis no Journey Otimizer
description: Saiba como criar e gerenciar perfis no Adobe Journey Otimizer
feature: Profiles
role: User
level: Beginner
...
Para saber como acessar e trabalhar com a **Painel de perfis** e informações detalhadas sobre as métricas exibidas no painel, consulte [esta seção](https://experienceleague.adobe.com/docs/experience-platform/profile/ui/user-guide.html){target=&quot;_blank&quot;}.
...
* [Documentação de Perfil do cliente em tempo real](https://experienceleague.adobe.com/docs/experience-platform/query/home.html){target=&quot;_blank&quot;}
