...
**Nesta página:** encontre respostas para perguntas frequentes sobre integrações no Adobe Journey Optimizer, abrangendo configuração, autenticação, formatos e canais com suporte, permissões e solução de problemas.
