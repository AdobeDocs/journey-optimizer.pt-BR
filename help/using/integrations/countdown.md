...
**Nesta página:** saiba como inserir um timer de contagem regressiva do Dynamic Media nos emails do Journey Optimizer para criar urgência para vendas rápidas e promoções com reconhecimento de hora.
