...
## Gerenciamento de rejeição no Journey Optimizer {#opt-out-ajo}

Ao enviar mensagens de jornadas ou campanhas, você deve sempre garantir que os clientes possam cancelar a assinatura de comunicações futuras. Após o cancelamento da assinatura, os perfis serão removidos automaticamente do público-alvo de futuras mensagens de marketing.
...
Saiba como gerenciar opções de rejeição em emails e mensagens SMS do Journey Optimizer nestas seções:
