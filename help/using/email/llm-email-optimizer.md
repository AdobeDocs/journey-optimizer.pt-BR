...
1. Selecione o ícone de **[!UICONTROL Texto sem formatação]** para abrir a versão de texto do seu email. [Saiba mais](text-version-email.md)
...
1. A versão de texto do email é exibida. Clique no botão **[!UICONTROL Otimizar para Caixa de Entrada de IA]** para gerar uma versão de texto simples aprimorada que destaque as principais informações para leitura e resumo assistidos por IA.
   ...
   >[!NOTE]
   >
   >Ao clicar no botão **[!UICONTROL Otimizar para Caixa de Entrada de IA]**, a opção **[!UICONTROL Sincronizar com o HTML]** é automaticamente desabilitada. [Saiba mais](text-version-email.md#plain-text-custom)
...
1. O texto gerado é exibido. Revise as alterações, edite-as se necessário e salve seu email como de costume.
   ...
   >[!NOTE]
   >
   >**Otimizar texto de email para caixas de entrada de IA** atualiza somente o corpo de texto simples. Isso não altera o design, o layout ou as imagens do HTML.
...
* **Exposição legal e de marca** — Resumos de IA incorretos ou incompletos ainda podem gerar confusão no cliente ou disputas sobre promoções, termos ou linguagem de recusa. **A otimização do texto de email para caixas de entrada de IA** melhora a camada de texto fornecida; ela não garante que o modelo de terceiros reproduzirá de forma fiel.
...
* [Gerenciar a versão de texto de um email](text-version-email.md)
