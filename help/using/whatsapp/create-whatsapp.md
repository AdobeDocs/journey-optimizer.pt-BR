...
**Nesta página:** adicione uma ação do WhatsApp a uma jornada ou campanha e crie o conteúdo a partir de um modelo aprovado do Meta, para poder enviar mensagens personalizadas e bem testadas ao seu público-alvo.
...
1. Use o **[!UICONTROL Simular conteúdo]** para visualizar o conteúdo da mensagem do WhatsApp, URLs encurtadas e conteúdo personalizado. [Saiba mais](send-whatsapp.md)
...
>[!VIDEO](https://video.tv.adobe.com/v/3470287/?captions=por_br&learn=on")
