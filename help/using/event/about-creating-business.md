...
* Para permitir várias execuções de eventos comerciais, ative a opção correspondente na **[!UICONTROL Execução]** das propriedades da jornada.
...
1. No **[!UICONTROL Tipo]** , escolha **Negócios**.
...
1. Quando terminar de selecionar os campos necessários, clique em **[!UICONTROL Salvar]** ou pressione **[!UICONTROL Enter]**.
   ...
   O número de campos selecionados é exibido em **[!UICONTROL Campos]**.
