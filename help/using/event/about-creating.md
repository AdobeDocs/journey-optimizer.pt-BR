...
1. Na seção de menu ADMINISTRAÇÃO, navegue até **[!UICONTROL Configurações]**, e na seção **[!UICONTROL Eventos]**, clique em **[!UICONTROL Gerenciar]**. A lista dos eventos é exibida.
