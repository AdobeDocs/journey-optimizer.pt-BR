...
**Nesta página:** Crie um cartão de conteúdo e defina seu conteúdo em uma jornada ou campanha para fornecer experiências personalizadas no aplicativo com as regras de entrega escolhidas.
...
>
>As regras de desqualificação exigem o Web SDK versão 2.28.0 ou posterior.
