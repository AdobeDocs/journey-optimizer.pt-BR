...
>[!CAUTION]
>
>Ao direcionar perfis pseudônimos (visitantes não autenticados) com seus cartões de conteúdo, considere definir um Tempo de vida (TTL) para exclusão automática de perfil para gerenciar a contagem de perfis ativáveis e os custos associados. [Saiba mais](../start/guardrails.md#profile-management-inbound)