...
>[!NOTE]
>
>Como a simulação não gera nenhum evento de decisão, a variável [limite](../offer-library/creating-personalized-offers.md#capping) não será afetada.
...
1. Selecionar **[!UICONTROL Add decision scope]**.
