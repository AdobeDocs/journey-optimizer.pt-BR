...
>[!TIP]
>
>O serviço de Decisão, o novo recurso de tomada de decisão do [!DNL Adobe Journey Optimizer], agora está disponível por meio da experiência baseada em código e dos canais de email. [Saiba mais sobre a Decisão](../../experience-decisioning/gs-experience-decisioning.md)
...
![Animação de modelo de otimização personalizada](../../rn/assets/do-not-localize/ai-ranking.gif)
