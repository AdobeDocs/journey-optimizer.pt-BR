...
1. Especifique um nome exclusivo e uma descrição para o modelo de IA e selecione o tipo de modelo de IA que deseja criar:
   ...
   * **[!UICONTROL Personalizado]** O otimiza e personaliza ofertas com base em segmentos e no desempenho da oferta. [Saiba mais](personalized-optimization-model.md)
...
1. Se você estiver criando uma **[!UICONTROL Personalização]** Modelo de IA, selecione os segmentos a serem usados para treinar o modelo de IA.
