...
* **[!UICONTROL Decisão em lote]**: forneça decisões de oferta a todos os perfis em um determinado segmento do Adobe Experience Platform. [Saiba mais](../batch-delivery.md)
