---
title: Glossário de ofertas
description: Glossário de ofertas
feature: Ofertas
topic: Integrações
role: User
level: Intermediate
...
Estes são os principais conceitos com os quais você trabalhará ao usar o Gerenciamento de decisão.
