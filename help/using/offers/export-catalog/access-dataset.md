...
description: Saiba como acessar o catálogo de ofertas na Adobe Experience Platform depois que ele for exportado
feature: Offers
topic: Integrations
role: User
level: Intermediate
...
O catálogo de ofertas exportado está acessível na Adobe Experience Platform **[!UICONTROL Datasets]** menu. Um conjunto de dados é criado para cada objeto da Biblioteca de ofertas.
