...
* Filtro de opções
   ...
   **Descrição:** A referência a um filtro baseado no qualificador de coleção (anteriormente conhecido como &quot;tag&quot;) que corresponde opções de um inventário usando seus qualificadores de coleção anexados. O valor é o URI (@id) da regra de decisão referenciada. Consulte esquema https://ns.adobe.com/experience/decisioning/filter.
   **Tipo:** sequência de caracteres
