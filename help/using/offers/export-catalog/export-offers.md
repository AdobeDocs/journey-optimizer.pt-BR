...
+++_experience > decisão > conteúdo > Disposição
...
++_experience > decisioning > profileConstraints > Descrição
...
+++_experience > decisão > classificação > Avaliação de pedidos
...
**Campo:** tags
**Título:** Tags
**Descrição:** O conjunto de qualificadores de coleção (anteriormente conhecidos como &quot;tags&quot;) associados a esta entidade. Os qualificadores de coleção são usados em expressões de filtro para restringir o inventário geral a um subconjunto (categoria).
**Tipo:** array
