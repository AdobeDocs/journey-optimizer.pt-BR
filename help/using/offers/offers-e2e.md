...
1. Você também pode criar um **qualificador de coleção**.
   ...
   Neste exemplo, crie a *Yoga* qualificador de coleção.

   ![](assets/offers-e2e-tag.png)

   As etapas detalhadas para criar qualificadores de coleção são descritas em [esta seção](../../using/offers/offer-library/creating-tags.md).
...
1. Use o *Yoga* qualificador de coleção para selecionar as quatro ofertas personalizadas que você criou anteriormente.
...
Agora que sua decisão está em execução, você pode inseri-la em uma mensagem de email. Para fazer isso, siga as etapas detalhadas em [esta página](../../using/email/add-offers-email.md).
