...
Inclua o seguinte trecho de JavaScript da Opção 2: A Versão Autônoma Pré-Compilada em [esta página](https://experienceleague.adobe.com/docs/experience-platform/edge/fundamentals/installing-the-sdk.html?lang=pt-BR) na seção `<head>` da sua página HTML.
