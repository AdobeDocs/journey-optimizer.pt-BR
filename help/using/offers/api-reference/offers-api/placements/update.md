...
# Atualizar um posicionamento

Você pode modificar ou atualizar uma disposição em seu contêiner fazendo uma solicitação de PATCH para a API [!DNL Offer Library].
...
Uma resposta bem-sucedida retorna os detalhes atualizados da disposição, incluindo a ID de instância exclusiva e a disposição `@id`.
