...
Você pode pesquisar ofertas personalizadas específicas fazendo uma solicitação GET para a variável [!DNL Offer Library] API que inclui a oferta personalizada `@id` ou o nome da oferta personalizada no caminho da solicitação.
