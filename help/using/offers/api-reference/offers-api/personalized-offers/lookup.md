...
Você pode pesquisar ofertas personalizadas específicas fazendo uma solicitação GET para a API [!DNL Offer Library] que inclui a ID da oferta personalizada no caminho da solicitação.
