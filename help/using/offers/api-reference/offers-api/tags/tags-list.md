...
Você pode exibir uma lista de todos os qualificadores de coleção em um contêiner executando uma única solicitação GET para a API da Biblioteca de ofertas.
