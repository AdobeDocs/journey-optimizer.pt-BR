...
As regras de decisão são restrições adicionadas a uma oferta personalizada e aplicadas a um perfil para determinar a elegibilidade. É possível exibir uma lista de regras de decisão existentes executando uma única solicitação do GET para [!DNL Offer Library] API.
