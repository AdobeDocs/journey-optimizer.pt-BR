...
Você pode confirmar a exclusão tentando uma solicitação de pesquisa (GET) para a oferta e deve receber um status HTTP 404 (Não encontrado) porque a oferta substituta foi removida.
