...
Você pode pesquisar coleções específicas fazendo uma solicitação GET para o [!DNL Offer Library] API que inclui a coleção `@id` ou o nome da coleção no caminho da solicitação.
