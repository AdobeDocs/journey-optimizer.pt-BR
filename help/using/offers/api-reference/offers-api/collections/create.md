...
Uma resposta bem-sucedida retorna informações sobre a coleção recém-criada, incluindo sua coleção exclusiva `id`. Você pode usar a coleção `id` em etapas posteriores, para atualizar ou excluir sua coleção ou use-a em um tutorial posterior para criar uma decisão.
