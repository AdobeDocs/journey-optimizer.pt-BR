...
1. Adicione representações para definir onde a oferta será exibida na mensagem. [Saiba mais](add-representations.md)
   ...
   Ao personalizar o conteúdo de representação, somente determinadas funções são suportadas — consulte [Funções suportadas no editor de personalização](personalization-editor-supported-functions.md).
