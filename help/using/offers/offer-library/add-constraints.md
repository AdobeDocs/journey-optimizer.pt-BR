...
Você pode adicionar até 10 regras de limitação para uma determinada oferta. Para definir uma regra de limite, clique no link **[!UICONTROL Criar limite]** e siga as etapas abaixo:
