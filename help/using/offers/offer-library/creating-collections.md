...
* **Coleções dinâmicas** são coleções de ofertas com base em qualificadores de coleção (anteriormente conhecidos como &quot;tags&quot;). Essas coleções são atualizadas automaticamente. Por exemplo, se uma nova oferta for criada com o qualificador de coleção selecionado, ela será automaticamente adicionada à coleção.
...
1. Para criar uma coleção dinâmica, use o painel esquerdo para selecionar o qualificador de coleção das ofertas a serem adicionadas à coleção e clique em **[!UICONTROL Salvar]**. Todas as ofertas com o qualificador de coleção selecionado serão salvas na coleção.
...
1. Para criar uma coleção estática, use o painel esquerdo para filtrar a lista de ofertas (status, qualificador de coleção, data, canal, tipo de conteúdo) e, em seguida, selecione as ofertas a serem adicionadas à coleção.
