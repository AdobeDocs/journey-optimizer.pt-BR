...
1. Para atribuir rótulos de uso de dados personalizados ou principais a uma coleção estática, selecione **[!UICONTROL Manage access]**. [Saiba mais sobre o Controle de Acesso no Nível do Objeto (OLAC)](../../administration/object-based-access.md)
