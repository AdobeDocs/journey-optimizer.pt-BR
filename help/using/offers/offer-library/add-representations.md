...
1. Digite o texto que será exibido na oferta.
   ...
   >[!NOTE]
   >
   >Somente o **[!UICONTROL Atributos do perfil]**, **[!UICONTROL Associações de segmento]** e **[!UICONTROL Funções auxiliares]** As fontes de estão disponíveis para a Gestão de decisões.
