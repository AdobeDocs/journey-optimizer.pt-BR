...
>
>Quando você usa o editor de personalização na Gestão de decisões, somente um subconjunto de funções é compatível — consulte [Funções compatíveis no editor de personalização](personalization-editor-supported-functions.md).
...
Você pode personalizar URLs usando o editor de personalização. Saiba mais sobre a [personalização](../../personalization/personalize.md#use-expression-editor). Na Gestão de decisões, somente determinadas funções são suportadas — consulte [Funções suportadas no editor de personalização](personalization-editor-supported-functions.md).
