...
Entender como os clientes interagem com suas comunicações é fundamental para criar experiências significativas e gerar resultados. O Journey Optimizer oferece recursos abrangentes de rastreamento e monitoramento que dão a você visibilidade do comportamento do cliente, do desempenho do delivery e da integridade do sistema — tudo isso respeitando a privacidade e mantendo a conformidade.
...
### Rastreamento de notificação por push {#push-tracking}
...
### Rastreamento de mensagens no aplicativo {#inapp-tracking}
...
### Rastreamento de SMS e MMS {#sms-tracking}
...
### Rastreamento de experiência baseado em código {#code-based-tracking}
...
### Rastreamento de cartão de conteúdo {#content-card-tracking}
...
## Monitorar páginas de aterrissagem {#landing-page-tracking}
...
## Gerenciar o desempenho da otimização {#optimization-tracking}

O Journey Optimizer rastreia automaticamente experimentos de otimização e estratégias de direcionamento. Configure suas otimizações para garantir a coleta de dados adequada.
...
**Pré-requisitos para o rastreamento baseado em código:**

Para rastrear as decisões em experiências baseadas em código, certifique-se de que sua implementação envie eventos de interação de apresentação (exibições e cliques) para a Adobe Experience Platform usando o Web SDK ou o Mobile SDK. [Saiba mais](../experience-decisioning/gs-experience-decisioning.md)
...
## Próximas etapas: acessar os dados de rastreamento {#access-tracking-data}

Depois que o rastreamento é configurado, você pode acessar os dados por meio dos recursos de relatório integrados da Journey Optimizer:

* **Monitoramento em tempo real** - visualize métricas ativas à medida que jornadas e campanhas são executadas para identificar problemas rapidamente
* **Análise histórica** - Analise o desempenho anterior para entender tendências e otimizar campanhas futuras
* **Análises avançadas** - Conecte-se à Customer Journey Analytics para sofisticada análise entre canais e modelagem de atribuição

[Introdução aos relatórios](../reports/gs-reports.md) | [Saiba mais sobre a integração com o Customer Journey Analytics](../reports/cja-ajo.md)

## Explorar os principais tópicos {#explore-topics}
