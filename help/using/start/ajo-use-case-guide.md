...
title: Qual recurso do Journey Optimizer para este trabalho?
description: Um guia de decisão que mapeia objetivos comuns de profissionais para o recurso certo do Adobe Journey Optimizer, com tutoriais práticos, para que você possa encontrar a ferramenta certa para o que deseja realizar e começar rapidamente.
feature: Get Started
...
# Qual recurso do Journey Optimizer para este trabalho? {#ajo-use-case-guide}
...
>[!TIP]
>
>Novo no Journey Optimizer? Navegue pelos [tutoriais completos do Journey Optimizer](https://experienceleague.adobe.com/pt-br/docs/journey-optimizer-learn/tutorials/overview){target="_blank"} (vídeos e apresentações guiadas), siga uma [lista de reprodução de vídeo](https://experienceleague.adobe.com/pt-br/playlists?solution=Journey+Optimizer){target="_blank"} com curadoria de um especialista e pratique em uma [sandbox de treinamento](https://experienceleague.adobe.com/pt-br/docs/journey-optimizer-learn/configure-a-training-sandbox/introduction-and-prerequisites){target="_blank"} ou com os [desafios práticos](https://experienceleague.adobe.com/pt-br/docs/journey-optimizer-learn/challenges/introduction-and-prerequisites){target="_blank"}.
...
Comece com o canal que deseja enviar: [Email](../email/get-started-email.md) · [Push](../push/get-started-push.md) · [SMS/MMS/RCS](../mobile/get-started-mobile.md) · [Web](../web/get-started-web.md) · [No aplicativo](../in-app/get-started-in-app.md). Para obter orientação específica sobre dispositivos móveis, explore o [Hub de Aprendizagem Móvel](https://experienceleague.adobe.com/pt-br/docs/journey-optimizer-learn/mobile-learning-hub/overview){target="_blank"}.

## Medir e otimizar {#measure-optimize}

Acompanhe o desempenho e refine: [Relatórios ao vivo](../reports/live-report.md) · [Monitore e analise sua jornada com relatórios ao vivo](https://experienceleague.adobe.com/pt-br/docs/journey-optimizer-learn/tutorials/report-and-monitor/monitor-and-analyze-your-journey-with-live-reports){target="_blank"}. Para analisar experimentos e obter recomendações para a próxima etapa, use o [Experimentation Agent](ai-features.md#experimentation-agent) **(AI)** ([tutorial](https://experienceleague.adobe.com/pt-br/docs/journey-optimizer-learn/tutorials/experimentation/experimentation-agent-overview){target="_blank"}).
