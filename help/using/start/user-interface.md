...
**Nesta página:** encontre tudo na interface do Adobe Journey Optimizer — barra superior, página inicial e navegação à esquerda — para poder acessar rapidamente os recursos e as funcionalidades necessários.
...
Use o ícone de pesquisa para localizar rapidamente jornadas, campanhas, ativos e outros objetos no Journey Optimizer. Digite palavras-chave para ver resultados relevantes de todas as áreas da plataforma. [Saiba mais sobre a pesquisa universal](search-filter-categorize.md#unified-search).
...
1. Clique no ícone do perfil e selecione **[!UICONTROL Preferências]**
2. Em **[!UICONTROL Notificações]**, localize **[!UICONTROL Journey Optimizer]**
3. Habilite os tipos de notificação que deseja receber
...
* **Criar perfis de teste** - Gerar perfis de teste com modelos CSV
* **Enviar mensagens de aniversário** - Enviar emails de aniversário automaticamente (em breve)
* **Integrar novos clientes** - Série de boas-vindas para novos clientes (em breve)
...
* **Destinos** - Exporte dados para o armazenamento na nuvem. [Configurar destinos](../data/export-datasets.md). Se sua organização tiver o Real-Time CDP ou o Adobe Journey Optimizer, você também poderá ativar públicos para destinos de personalização qualificados, como o Adobe Target, no [catálogo de destinos do Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/destinations/catalog/overview.html?lang=pt-BR){target="_blank"}.
...
* [Escolha o caminho de aprendizagem por função](quick-start.md)
* [Pesquisar, filtrar e categorizar conteúdo](search-filter-categorize.md)
