...
* **[!UICONTROL Canais]** : use esta seção para configurar seus canais, incluindo subdomínios, superfícies e configurações de entrega. [Saiba mais](../configuration/get-started-configuration.md)
