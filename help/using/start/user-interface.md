...
* **[!UICONTROL Ativos]** - o [!DNL Adobe Experience Manager Assets] é um repositório centralizado de ativos que podem ser usados para preencher as suas mensagens. [Saiba mais](../integrations/assets.md)
...
* **[!UICONTROL Regras de negócios]**: use esta seção para criar regras de negócios entre canais, a fim de controlar a frequência com que usuários recebem uma mensagem ou entram em uma jornada. [Saiba mais](../conflict-prioritization/rule-sets.md)
...
* **[!UICONTROL Tags]**: com as tags unificadas, é possível classificar facilmente suas jornadas e campanhas para aprimorar a pesquisa nas listas. [Saiba mais](../start/search-filter-categorize.md#manage-tags)
...
Saiba como acessar e usar o Assistente de IA [nesta página](ai-assistant.md).
...
>abstract="Edição desabilitada (campanhas)"
...
>abstract="Status de aprovação"

>[!CONTEXTUALHELP]
>id="ajo_campaigns_approve"
>title="Aprovar"
>abstract="Aprovar (campanhas)"
