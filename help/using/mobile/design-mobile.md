...
**Nesta página:** saiba como projetar e personalizar conteúdo de mensagens SMS, RCS e MMS no Adobe Journey Optimizer, incluindo mídia avançada RCS, texto de fallback, ações sugeridas, URLs rastreadas e mídia adicionada.
...
1. No painel de criação, escolha seu **[!UICONTROL Tipo de conteúdo]**:
   ...
   1. Clique em **[!UICONTROL Adicionar cartão]** para adicionar um cartão ao carrossel.
...
1. Nos campos **[!UICONTROL Texto da mensagem]** ou **[!UICONTROL Descrição]**, digite o conteúdo da mensagem. Você pode usar a personalização para adaptar o texto a cada perfil. Observe que os limites de caracteres variam de acordo com o tipo de mensagem: 3.072 caracteres para mídia avançada (único) e 160 para RCS básico.
...
1. Gere mensagens móveis envolventes personalizadas para seu público usando [Gerar texto com IA](../content-management/generative-text.md).
