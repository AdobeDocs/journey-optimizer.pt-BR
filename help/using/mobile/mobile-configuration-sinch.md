...
**Nesta página:** Saiba como configurar a Sinch como seu provedor no Adobe Journey Optimizer, configurando credenciais de API separadas para mensagens SMS, MMS e RCS.
