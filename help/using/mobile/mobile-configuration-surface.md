...
**Nesta página:** Saiba como criar uma configuração de canal de mensagens móveis no Adobe Journey Optimizer definindo o tipo de mensagem, a configuração móvel, o número do remetente, o subdomínio e o campo de execução para enviar mensagens SMS, RCS e MMS.
