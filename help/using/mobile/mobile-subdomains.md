...
**Nesta página:** Saiba como configurar subdomínios SMS no Adobe Journey Optimizer para encurtar URLs em suas mensagens, usando um subdomínio delegado existente ou configurando um novo com um registro DNS.
