...
**Nesta página:** Saiba como adicionar uma ação de mensagem móvel a uma jornada ou campanha no Adobe Journey Optimizer e, em seguida, selecione uma configuração e edite o conteúdo para enviar texto, comunicações avançadas e mensagens multimídia.
