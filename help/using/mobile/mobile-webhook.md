...
>[!NOTE]
>
>Os dados de palavra-chave de entrada são armazenados no _conjunto de dados do sistema do_ do AJO Inbound Activity Event, a menos que um conjunto de dados personalizado esteja configurado. Um perfil deve ter pelo menos uma mensagem enviada de [!DNL Journey Optimizer] antes que as mensagens de entrada sejam capturadas. [Saiba mais](../data/get-started-datasets.md#system-datasets)
...
1. Defina as configurações do webhook, conforme detalhado abaixo:
   ...
   * **[!UICONTROL Credenciais da API]**: escolha no menu suspenso suas [credenciais de API configuradas anteriormente](mobile-configuration-sinch.md).
...
1. Defina as configurações do webhook, conforme detalhado abaixo:
   ...
   * **[!UICONTROL Credenciais da API]**: escolha no menu suspenso suas [credenciais de API configuradas anteriormente](mobile-configuration-infobip.md#api-credential).
...
1. Defina as configurações do webhook, conforme detalhado abaixo:
   ...
   * **[!UICONTROL Credenciais da API]**: escolha no menu suspenso suas [credenciais de API configuradas anteriormente](mobile-configuration-custom.md).
