...
description: Saiba como criar relatórios da Gestão de decisões usando conjuntos de dados de eventos e o esquema DecisioningEvents do XDM para analisar o desempenho da oferta e os resultados da decisão.
...
Use os dados do evento da Gestão de decisões e o esquema DecisioningEvents do XDM para criar relatórios personalizados no Adobe Journey Optimizer. Esta seção aborda como trabalhar com conjuntos de dados de evento e acessar os campos XDM necessários para analisar seleções de ofertas, uso de substitutos e eficácia do posicionamento.
