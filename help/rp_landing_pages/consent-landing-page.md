...
Saiba como gerenciar tópicos de assinatura e preferências de canal usando políticas de consentimento, para direcionar os clientes com base em suas escolhas, respeitando o consentimento.
...
- **[Gerenciar recusa de mensagem móvel](../using/mobile/mobile-opt-out.md)** - Configurar a recusa e o cancelamento de assinatura de SMS/MMS/RCS.
