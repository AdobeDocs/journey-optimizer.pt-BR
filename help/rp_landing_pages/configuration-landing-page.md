...
A configuração de canais no Adobe Journey Optimizer permite gerenciar como as mensagens são entregues em vários canais, como email, SMS, notificações por push e Web, garantindo uma comunicação personalizada e eficaz.
...
[Explorar configuração de canal guiada](../using/configuration/set-mobile-config.md)
:::
...
- **[Monitoramento e solução de problemas](troubleshoot-journey-landing-page.md)**: faça o diagnóstico e resolva problemas rapidamente, incluindo a solução de problemas de delegação de subdomínio personalizado.
