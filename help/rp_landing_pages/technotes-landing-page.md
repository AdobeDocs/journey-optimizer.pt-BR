...
Essas notas técnicas explicam os métodos estatísticos usados na experimentação e nos relatórios do Adobe Journey Optimizer. Use-as para entender como os experimentos são monitorados, como as métricas (por exemplo, aumento e taxa de conversão) são computadas e como interpretar os resultados com confiança.
