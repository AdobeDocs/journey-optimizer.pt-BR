...
[Otimizar campanhas](../using/content-management/gs-message-optimization.md)
:::
...
- **[Agendar a campanha de ação](../using/campaigns/campaign-schedule.md)**: configure as datas inicial e final, a frequência e o agendamento específico por canal para sua campanha.
