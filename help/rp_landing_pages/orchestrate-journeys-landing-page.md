...
- **[Tutoriais de jornadas](https://experienceleague.adobe.com/pt-br/docs/journey-optimizer-learn/tutorials/journeys/journey-designer-overview){target="_blank"}**: saiba mais sobre a criação de jornadas por meio de tutoriais em vídeo práticos que abrangem recursos, funcionalidades e práticas recomendadas.
