...
[Leia mais sobre a função “distinct”](../using/building-journeys/functions/list-functions.md#distinct)
:::
...
[Saiba mais sobre a função “distinctWithNull”](../using/building-journeys/functions/list-functions.md#distinctWithNull)
:::
...
[Explore os detalhes da função “filter”](../using/building-journeys/functions/list-functions.md#filter)
:::
...
[Noções básicas da função “getListItem”](../using/building-journeys/functions/list-functions.md#getListItem)
:::
...
[Saiba mais sobre a função “in”](../using/building-journeys/functions/list-functions.md#in)
:::
...
[Confira a função “intersect”](../using/building-journeys/functions/list-functions.md#intersect)
:::
...
- **[Usar a função `limit` no Adobe Journey Optimizer](../using/building-journeys/functions/list-functions.md#limit)**: saiba como limitar uma lista ao primeiro ou aos últimos N elementos com a função “limit”.
- **[Referência da função “listSize”](../using/building-journeys/functions/list-functions.md#listSize)**: descubra como contar o número de elementos de uma lista com a função “listSize”.
- **[Função “serializeList” no Adobe Journey Optimizer](../using/building-journeys/functions/list-functions.md#serializeList)**: converta listas em strings com formatação personalizável, usando a função “serializeList”.
- **[Função “sort” no Adobe Journey Optimizer](../using/building-journeys/functions/list-functions.md#sort)**: saiba como classificar listas de valores ou objetos na ordem natural com a função “sort”.
