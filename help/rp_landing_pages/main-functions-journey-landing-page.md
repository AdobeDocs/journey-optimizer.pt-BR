...
As funções do Adobe Journey Optimizer permitem criar expressões dinâmicas e precisas de acordo com as jornadas do cliente. Independentemente de estar avaliando a associação de público-alvo, agregando dados, convertendo formatos, manipulando datas ou processando listas, cada categoria das funções tem um propósito exclusivo na otimização de fluxos de trabalho. Com ferramentas para cálculos matemáticos, personalização de strings e muito mais, essas funções fornecem possibilidades infinitas para criar condições avançadas. Ao explorar as próximas seções, é possível encontrar exemplos práticos e orientações detalhadas que simplificam operações complexas, ajudando a atingir todo o potencial da orquestração de jornadas personalizada.
...
[Mergulhe nas funções de agregação](../using/building-journeys/functions/aggregation-functions.md)
:::
...
[Explore as funções de conversão](../using/building-journeys/functions/conversion-functions.md)
:::
...
[Visualizar documentação de funções de data](../using/building-journeys/functions/date-functions.md)
:::
...
[Saiba mais sobre as funções de lista](../using/building-journeys/functions/list-functions.md)
:::
...
- **[Funções matemáticas](../using/building-journeys/functions/math-functions.md)**: explore as funções matemáticas, como aleatório e arredondamento, para cálculos numéricos em expressões de jornadas.
- **[Funções de string do Adobe Journey Optimizer](../using/building-journeys/functions/string-functions.md)**: manipule strings com as funções de concatenação, extração de substrings, formatação e muito mais em expressões de jornadas.
