...
description: Saiba como configurar ações personalizadas no Journey Optimizer para conectar jornadas a sistemas de terceiros por meio de chamadas de API, respostas, monitoramento e governança.
...
Acompanhe o desempenho e a execução de ações personalizadas em suas jornadas usando recursos integrados de monitoramento e relatórios.
