...
[Configurar Otimizar e condições](../using/building-journeys/optimize.md)
:::
...
- **[Ações integradas em canais](../using/building-journeys/journey-action.md)**: use as jornadas para entregar mensagens ou experiências por email, SMS, notificações por push, mensagem no aplicativo, pela web e através de experiências baseadas em código ou cartões de conteúdo usando os recursos integrados do Journey Optimizer.
