...
[Explorar a função “random”](../using/building-journeys/functions/math-functions.md#random)
:::
...
[Saiba mais sobre a função “round”](../using/building-journeys/functions/math-functions.md#round)
:::
